  ...
  return (
    <div className="container mx-auto flex">
      <div className="w-[100] sm:w-[50%]">
        <h1 className="text-3xl my-5 sm:text-2xl">
        ...
        <div className="flex gap-10 mt-3">
          ...
          <button className=" bg-white text-[#45C9A1] rounded-full p-5 shadow-lg py-4 px[6em]">
            About Us
          </button>
        </div>
        <div className="border-2 rounded-full mt-6 flex justify-start items-center p-3">
          ...
          <input
            type="text"
            className="w-[100%] sm-w-[50%] p-4 border-1 outline-none text-4xl"
            placeholder="Search"
          />
        </div>
      </div>
      <div className="hidden sm:block w-50% bg-[url('assets/images/hero2.png') bg-no-repeat bg-right bg-contain]"></div>
    </div>
  );
}
